	...
	fetch : function() {
		this.reset([
			...
			},
			{
				titleId : 'contact',
				title : 'contact',
				text : '<h1>Contact</h1><a href="mailto:info@nephinumerics.com">info@nephinumerics.com</a>',
				url : 'contact'
			}
		])
	},
